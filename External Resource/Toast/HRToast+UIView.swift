...
let HRToastPositionCenterAbove = "centerabove"
let HRToastPositionCenterAbovePlus = "centeraboveplus"
...
//let HRToastColorBlue0 = UIColor(red: 0.5, green: 0.73, blue: 0.96, alpha: 1.0).colorWithAlphaComponent(HRToastOpacity)
let HRToastColorDukeBlueTranslucent = AppConstants.Color.DukeBlueTranslucent
...
extension UIView {
    ...
    */
    ...
    func showToast(toast toast: UIView, duration: Double, position: AnyObject) {
        ...
        if let existToast = objc_getAssociatedObject(self, &HRToastView) as? UIView {
    ...
    func makeToastActivity(position pos: AnyObject, message msg: String = "") {
        ...
        activityView.backgroundColor = HRToastColorDukeBlueTranslucent
    ...
    func hideToastActivity() {
        ...
        if let existingActivityView = objc_getAssociatedObject(self, &HRToastActivityView) as? UIView {
            UIView.animateWithDuration(HRToastFadeDuration,
                delay: 0.0,
                options: UIViewAnimationOptions.CurveEaseOut,
                animations: {
    ...
    */
    ...
    func centerPointForPosition(position: AnyObject, toast: UIView) -> CGPoint {
        if position is String {
            ...
            } else if position.lowercaseString == HRToastPositionCenterAbove {
                return CGPointMake(viewSize.width/2, viewSize.height/2 * 0.7)
            } else if position.lowercaseString == HRToastPositionCenterAbovePlus {
                return CGPointMake(viewSize.width/2, viewSize.height/2 * 0.5)
            }
    ...
    func viewForMessage(msg: String?, title: String?, image: UIImage?) -> UIView? {
        ...
        //wrapperView.backgroundColor = UIColor.greenColor().colorWithAlphaComponent(HRToastOpacity)
        wrapperView.backgroundColor = HRToastColorDukeBlueTranslucent
        if HRToastDisplayShadow {
